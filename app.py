...
def get_model():
    ...
    tokenizer = AutoTokenizer.from_pretrained("MariamAde/Mistral_finetuned_v2") #MariamAde/Mistral_finetuned_Base2
    model = AutoModelForCausalLM.from_pretrained("MariamAde/Mistral_finetuned_v2").to(device)
